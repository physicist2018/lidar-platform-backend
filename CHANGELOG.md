...
- `GET /api/experiments/{id}/{wavelength}/{polarization}/{channelType}/{plotType}/json` — скачивание Plot.ly JSON ранее сгенерированного heatmap или profile. Query-параметр `kind=heatmap|profile` (по умолчанию `heatmap`)
